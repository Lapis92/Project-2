...
int main() {
    ...
    client_fds = (int*)malloc(size_of_array*sizeof(int));
    while (1) {
	...
	//update the client_fd array since a new client has connected
	client_fds = (int*)malloc((size_of_array+1)*sizeof(int));
	client_fds[size_of_array] = client_fd;
